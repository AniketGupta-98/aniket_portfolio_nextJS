...
import { ExternalLink, Download, Mail, ChevronDown } from 'lucide-react'
import { useTheme } from '../../lib/ThemeContext'
import { PERSONAL_INFO, SOCIAL_LINKS } from '../../Details/Data'
import { ANIMATION_VARIANTS } from '../../Details/animations'
...
export default function HeroSection() {
    ...
    return (
        <section id="home" className={`pt-16 min-h-screen flex items-center relative overflow-hidden transition-colors duration-300 ${isDarkMode
            ...
            <div className="absolute inset-0">
                {[...Array(20)].map((_, i) => (
                    <motion.div
                        key={i}
                        className={`absolute w-2 h-2 rounded-full ${isDarkMode ? 'bg-blue-400/10' : 'bg-blue-400/20'
                            }`}
                        animate={{
                            x: [0, 100, 0],
                            y: [0, -100, 0],
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <motion.div
                            className={`inline-flex items-center px-4 py-2 rounded-full transition-colors duration-300 ${isDarkMode
                        ...
                        <motion.h1
                            ...
                            variants={ANIMATION_VARIANTS.fadeInUp}
                        >
                            <span className={isDarkMode ? 'text-white' : 'text-gray-900'}>Hi, I&lsquo;m </span>
                            <TypeAnimation
                                sequence={[
                                    'Aniket Gupta',
                                    4000,
                        ...
                        <motion.div
                            className={`text-lg md:text-xl lg:text-2xl font-medium transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
                                }`}
                            variants={ANIMATION_VARIANTS.fadeInUp}
                        >
                        ...
                        <motion.div
                            className={`text-base md:text-lg font-medium transition-colors duration-300 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'
                                }`}
                            variants={ANIMATION_VARIANTS.fadeInUp}
                        >
                        ...
                        <motion.p
                            className={`text-base md:text-lg leading-relaxed max-w-2xl transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
                                }`}
                            variants={ANIMATION_VARIANTS.fadeInUp}
                        >
                        ...
                        >
                            {[
                                ...
                                >
                                    ...
                                    <div className={`text-xs md:text-sm font-medium transition-colors duration-300 ${isDarkMode ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-500 group-hover:text-gray-700'
                                        }`}>
                                        {stat.label}
                                    </div>
                                </motion.div>
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                className={`group px-6 py-3 sm:px-8 sm:py-4 border-2 rounded-xl font-semibold transition-all duration-300 ${isDarkMode
                    ...
                    >
                        <motion.div
                            className={`relative mx-auto w-80 h-96 rounded-3xl shadow-xl overflow-hidden transition-colors duration-300 ${isDarkMode
                        ...
                        {[
                            ...
                            { name: "Node", position: "top-24 left-6", delay: 0.1 },
                            { name: "TS", position: "bottom-24 right-6", delay:0 },
                            { name: "JS", position: "bottom-8 left-8", delay: 0.1 },
                        ].map((tech, index) => (
                            <motion.div
                                key={index}
                                className={`absolute ${tech.position} w-14 h-14 backdrop-blur-sm border rounded-xl flex items-center justify-center text-sm font-bold shadow-lg transition-colors duration-300 ${isDarkMode
